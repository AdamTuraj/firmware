...
/* Private defines -----------------------------------------------------------*/
#define VOLUME_GAIN_Pin GPIO_PIN_0
#define VOLUME_GAIN_GPIO_Port GPIOA
#define MIC_GAIN_Pin GPIO_PIN_1
#define MIC_GAIN_GPIO_Port GPIOA
#define SPI1_CS_Pin GPIO_PIN_2
#define SPI1_CS_GPIO_Port GPIOA
#define LNA_EN_Pin GPIO_PIN_4
#define LNA_EN_GPIO_Port GPIOA
#define PA_EN_Pin GPIO_PIN_5
...
#define PTT_BUTTON_Pin GPIO_PIN_9
#define PTT_BUTTON_GPIO_Port GPIOA
