...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin|LNA_EN_Pin|PA_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RF_RESET_GPIO_Port, RF_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SPI1_CS_Pin LNA_EN_Pin PA_EN_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin|LNA_EN_Pin|PA_EN_Pin;
